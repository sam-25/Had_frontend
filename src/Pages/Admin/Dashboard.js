  ...
  return (
    <div>
        ...
        <div className="mb-4">
            ...
            <div className="flex flex-col gap-4" style={{ width: "25%", marginLeft: "25px", marginTop: "30px", marginRight: "1rem" }}>
            <h2 className="text-center mb-4 text-3xl font-bold text-gray-800">Admin Dashboard</h2>
